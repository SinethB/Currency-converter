...
export default function MainPage() {
    ...
    <div>
        ...
        <p className="lg:mx-32 opacity-60 py-6">
            Welcome to "Convert Your Currencies Today"! This application allows Your
            ...
            the value of your money in different currencies, this tool is here to help.
        </p>
    ...
    {!loading ? (
    <section className='lg:mx-80 text-xl opacity-60 py-6 mt-5'>
